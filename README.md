...
2. **Kind Cluster**: For chart installation testing, a Kubernetes in Docker (kind) cluster version 1.36 is automatically created.
...
|:-----------------------------|:----------|:-------------|:-----------------------|:------------------|:---------|
| argo-cd                      | 10.9.2    | v3.5.3       | krci                   | False             | False    |
...
| cert-manager                 | v1.21.2   | v1.21.2      | cert-manager           | False             | False    |
...
| envoy-gateway                | 1.9.1     | 1.9.1        | envoy-gateway-system   | False             | False    |
| envoy-gateway-resources      | 1.9.1     | 1.9.1        | envoy-gateway-system   | False             | False    |
| ingress-nginx                | 4.15.1    | 1.15.1       | ingress-nginx          | False             | False    |
| ingress-nginx-external       | 4.15.1    | 1.15.1       | ingress-nginx-external | False             | False    |
...
| krci-audit                   | 0.2.0     | 0.2.0        | krci-audit             | True              | False    |
...
| prometheus-operator          | 91.5.2    | v0.94.1      | monitoring             | False             | False    |
...
| tekton-monitoring            | 0.1.0     | 0.1.0        | tekton-pipelines       | False             | False    |
