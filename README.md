...
| aws-efs-csi-driver           | 2.1.10    | 2.1.10       | kube-system            | N/A               | False    |
...
| fluent-bit                   | 0.52.0    | 4.0.7        | logging                | False             | False    |
...
| ingress-nginx                | 4.13.1    | 1.13.1       | ingress-nginx          | False             | False    |
| ingress-nginx-external       | 4.13.1    | 1.13.1       | ingress-nginx-external | False             | False    |
| jaeger-operator              | 2.57.0    | 1.61.0       | jaeger-operator        | False             | False    |
| karma-dashboard              | 2.10.0    | v0.121       | monitoring             | False             | False    |
...
| keycloak                     | 7.1.1     | 26.3.2       | security               | False             | False    |
...
| minio-operator               | 0.1.0     | 7.1.1        | minio-operator         | False             | False    |
| moon                         | 2.7.6     | 2.7.6        | moon                   | False             | False    |
| nexus-ce                     | 7.11.0    | 7.11.0       | nexus                  | False             | False    |
| nexus-operator               | 3.5.0     | 3.5.0        | nexus                  | False             | False    |
| nexus                        | 61.0.3    | 3.70.3       | nexus                  | False             | False    |
| oauth2-proxy                 | 7.11.0    | 7.11.0       | oauth2-proxy           | False             | False    |
...
| prometheus-operator          | 76.3.0    | v0.84.1      | monitoring             | False             | False    |
| prometheus-blackbox-exporter | 9.7.0     | v0.26.0      | monitoring             | False             | False    |
| redis-operator               | 1.3.0     | 3.3.0        | redis-operator         | False             | False    |
