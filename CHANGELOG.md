...
### Features
- Update moon to the latest version ([#386](https://github.com/epam/edp-cluster-add-ons/issues/386))
- Update krci-ai to the latest version ([#338](https://github.com/epam/edp-cluster-add-ons/issues/338))
- Align vault-operator usage ([#376](https://github.com/epam/edp-cluster-add-ons/issues/376))
- Add GitHub Copilot integration to improve developer experience ([#296](https://github.com/epam/edp-cluster-add-ons/issues/296))
...
### Routine
- Upgrade Dependency Track to 0.41.0 ([#396](https://github.com/epam/edp-cluster-add-ons/issues/396))
- Remove qualityprofile_edp.yaml and qualitygate_edp.yaml ([#392](https://github.com/epam/edp-cluster-add-ons/issues/392))
- Upgrade Ingress-nginx to 1.14.2 ([#394](https://github.com/epam/edp-cluster-add-ons/issues/394))
- Bump argocd to v9 3 4 ([#390](https://github.com/epam/edp-cluster-add-ons/issues/390))
- Update Karpenter to 1.8.4 ([#388](https://github.com/epam/edp-cluster-add-ons/issues/388))
- Update Tekton to LTS ([#384](https://github.com/epam/edp-cluster-add-ons/issues/384))
- Bump KRCI to 3-12-4 version ([#381](https://github.com/epam/edp-cluster-add-ons/issues/381))
- Avoid duplicate service names in nexus-ce chart. Added name to registries ([#374](https://github.com/epam/edp-cluster-add-ons/issues/374))
- Added the ability to select a Sonar mode to reflect the health of all projects in this instance ([#379](https://github.com/epam/edp-cluster-add-ons/issues/379))
- Avoid duplicate service names in nexus-ce chart ([#374](https://github.com/epam/edp-cluster-add-ons/issues/374))
- Delete deprecated Sonar rules ([#373](https://github.com/epam/edp-cluster-add-ons/issues/373))
- Add velero application to Add-Ons ([#371](https://github.com/epam/edp-cluster-add-ons/issues/371))
- Bump KRCI to 3.12.3 ([#330](https://github.com/epam/edp-cluster-add-ons/issues/330))
- Bump ArgoCD chart version to 8.5.6([#367](https://github.com/epam/edp-cluster-add-ons/issues/367))
- Bump keycloak-operator version ([#365](https://github.com/epam/edp-cluster-add-ons/issues/365))
- Bump KRCI to 3.12.2 ([#330](https://github.com/epam/edp-cluster-add-ons/issues/330))
- Update Karpenter role name ([#362](https://github.com/epam/edp-cluster-add-ons/issues/362))
- Migrate images bitnami to bitnamilegacy([#360](https://github.com/epam/edp-cluster-add-ons/issues/360))
- Bump Vault to 1.20.1 ([#355](https://github.com/epam/edp-cluster-add-ons/issues/355))
- Bump open-telemetry operator version([#357](https://github.com/epam/edp-cluster-add-ons/issues/357))
- Bump Harbor version ([#353](https://github.com/epam/edp-cluster-add-ons/issues/353))
- Update chart and application versions ([#330](https://github.com/epam/edp-cluster-add-ons/issues/330))
- Bump defectdojo version([#350](https://github.com/epam/edp-cluster-add-ons/issues/350))
- Bump report-portal version([#348](https://github.com/epam/edp-cluster-add-ons/issues/348))
- Unify Atlantis keycloak client secret reference ([#333](https://github.com/epam/edp-cluster-add-ons/issues/333))
- Add DevOps agent based on kuberocketai framework ([#338](https://github.com/epam/edp-cluster-add-ons/issues/338))
- Bump Dependency Track version to 4.13.3 ([#346](https://github.com/epam/edp-cluster-add-ons/issues/346))
- Update OpenSearch chart version ([#340](https://github.com/epam/edp-cluster-add-ons/issues/340))
- Update pgadmin4 chart version ([#342](https://github.com/epam/edp-cluster-add-ons/issues/342))
- Update Prometheus Blackbox Exporter chart version ([#344](https://github.com/epam/edp-cluster-add-ons/issues/344))
- Bump PGO version to 5.8.2([#807](https://github.com/epam/edp-cluster-add-ons/issues/807))
- Update capsule to 0.7.4 ([#328](https://github.com/epam/edp-cluster-add-ons/issues/328))
- Add gitfusion deployment ([#323](https://github.com/epam/edp-cluster-add-ons/issues/323))
- Update nexus-ce chart version ([#319](https://github.com/epam/edp-cluster-add-ons/issues/319))
- Bump ArgoCD version to 8.2.5([#321](https://github.com/epam/edp-cluster-add-ons/issues/321))
- Update External Secrets Operator version ([#315](https://github.com/epam/edp-cluster-add-ons/issues/315))
- Bump sonarqube version ([#313](https://github.com/epam/edp-cluster-add-ons/issues/313))
- Update Karpenter version ([#317](https://github.com/epam/edp-cluster-add-ons/issues/317))
- Update KRCI and tekton-cache chart versions ([#311](https://github.com/epam/edp-cluster-add-ons/issues/311))
- Update Atlantis chart version ([#309](https://github.com/epam/edp-cluster-add-ons/issues/309))
- Bump Tekton components versions ([#307](https://github.com/epam/edp-cluster-add-ons/issues/307))
- Migrate to AL2023 ami ([#299](https://github.com/epam/edp-cluster-add-ons/issues/299))
- Add GitFusion routing to krakend ([#304](https://github.com/epam/edp-cluster-add-ons/issues/304))
- Migrate to AL2023 ami ([#299](https://github.com/epam/edp-cluster-add-ons/issues/299))
- Add pgAdmin application to Add-Ons([#299](https://github.com/epam/edp-cluster-add-ons/issues/299))
- Change readme file to show proper description ([#294](https://github.com/epam/edp-cluster-add-ons/issues/294))
- Update versions of platform component charts ([#294](https://github.com/epam/edp-cluster-add-ons/issues/294))
- Add atlantisUrl field to values.yaml ([#289](https://github.com/epam/edp-cluster-add-ons/issues/289))
- Bump Nexus Community Edition version([#277](https://github.com/epam/edp-cluster-add-ons/issues/277))
- Refactor Helm dependency by enabling running in parallel ([#279](https://github.com/epam/edp-cluster-add-ons/issues/279))
- Refactor Helm dependency checks by adding app version ([#279](https://github.com/epam/edp-cluster-add-ons/issues/279))
...
### Documentation
- refactor GitHub prompt files for improved usability ([#301](https://github.com/epam/edp-cluster-add-ons/issues/301))
- Add how-to for adding new addons ([#285](https://github.com/epam/edp-cluster-add-ons/issues/285))
