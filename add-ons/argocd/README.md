...
![Version: 5.33.2](https://img.shields.io/badge/Version-5.33.2-informational?style=flat-square) ![AppVersion: v2.7.2](https://img.shields.io/badge/AppVersion-v2.7.2-informational?style=flat-square)
...
|------------|------|---------|
| https://argoproj.github.io/argo-helm | argo-cd | 5.33.2 |
...
| argo-cd.server.ingress.hosts[0] | string | `"argocd-edp.example.com"` |  |
